...
def draw_velocity_text(screen, font, body, HEIGHT, y_offset=30, x = 0, y = 0):
    text = font.render(f"{body.velocity:.2f}", True, (0, 0, 0))
...
def show_interface(body1, body2):
    ...
    while running:
        ...
        draw_velocity_text(screen, font, body1, HEIGHT, x=50, y=50)
        draw_velocity_text(screen, font, body2, HEIGHT, x=WIDTH-50, y=50)
